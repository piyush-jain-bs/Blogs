...
<link rel="stylesheet" href="styles/manage_blog.css">
<!-- Bootstrap link -->
...
<div class="container-fluid mt-3 mb-3">
    ...
    <h4 class="ml-2 mb-0 fonts">Manage Blogs</h4><br>
    <div class="row mb-0">
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-12">
                    <?php 
                        $sql = "SELECT COUNT(bid) FROM blog where `uid` = $user_id";
                    ...
                    $sql = "SELECT * FROM `blog` where `uid` = $user_id LIMIT 2 OFFSET $offset";
                    $result = mysqli_query($conn, $sql);
                    ...
                    <div class="row mr-0 mt-3">
                        ...
                        <div class="col-md-8">
                            <div class="d-flex flex-column">
                                <div class="mb-1 mt-1 mr-2"><h4 class="fonts"><?php echo $row["title"]?></h4></div>
        ...
        <div class="col-md-3 mb-3">
            <form class="user_search_card fonts" action="manage_search.php" method="GET">
                <p class="mb-0 mt-3 fonts">Category : </p>
                <select name="selects" style="width:100%;height:30px;">
                    <option value="title">BY Title</option>
                    <option value="category">BY Category</option>
                    <option value="s_desc">BY Description</option>
                </select>
                <p class="mb-0 mt-3">Enter Input : </p>
   ...
   <!-- PAGINATION PART -->
    <center>
        <?php 
            ...
            {?>
                ...
                <?php if($b > 0 && ($b) <= $pagination) {?>
                  <span style="margin-top:20px;"><a href="manage_blogs.php?page=<?php echo $b?>"><?php echo $b?></a> <?php }?>
                  </span>
        ...
        <div class="mx-auto">   
            <?php if($offset > 0) {?>
                <a href="manage_blogs.php?page=<?php echo $no-1;?>">&laquo;</a> <?php }?>
            <?php if(($offset + 2) < $no_of_row) {?>
            <a class="mx-auto" href="manage_blogs.php?page=<?php echo $no+1;?>">&raquo;</a>  <?php }?>
        </div> 
