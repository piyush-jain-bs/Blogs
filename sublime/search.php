    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <?php
                    ...
                    $sql = "SELECT count(bid) FROM signup_user INNER JOIN blog ON signup_user.uid = blog.uid WHERE $selects like '%$types%'";
                    ...
                    $sql = "SELECT * FROM signup_user INNER JOIN blog ON signup_user.uid = blog.uid WHERE $selects like '%$types%' LIMIT 2 OFFSET $offset";
