		    ...
		    <form action="" method="POST">
			    <div class="blog_section">
				    <div class="blog_box">
					    ...
					    <label class="fonts mb-0 mt-1">Entry Title<sup>*</sup></label>
					    ...
					    <label class="fonts mb-0 mt-3">Main Image<sup>*</sup>
					    <input type="file" name="image" value="<?php echo $row['image']?>" required></label>

					    <label class="fonts mt-3 mb-0">Category<sup>*</sup></label>
					    ...
					    <textarea name="ldesc" placeholder="Please do not enter special Characters" style="height: 100px;"><?php echo $row['l_desc']?></textarea required>
					    <div style="color: red;" class="fonts mb-2"><?php echo $ldescErr;?></div>
